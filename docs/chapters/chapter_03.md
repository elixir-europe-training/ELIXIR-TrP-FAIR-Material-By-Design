...
| ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
-->  | Presentations   | ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
-->   | Website  | ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
-->   | Video   |
| :--------: | :--------: | :--------: | :--------: | :--------: | :--------: |
| ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
--> | Software | ![](../assets/images/03-formats.png)<!--
style = "width: 200px;"
--> | ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
--> | Guidelines |

|   _   | ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
-->     | Tutorial     | ![](../assets/images/03-formats.png)<!--
style = "width: 100px;"
-->    | Datasets     | _    |
